...
const Task = ({ task }) => {
  ...
  const { handleModalEditTask, handleDeleteModalTask, handleTaskStateShift } =
    useProject();

  const admin = useAdmin();

  return (
    <div className="border-b p-5 flex flex-col sm:flex-row justify-between sm:items-center">
